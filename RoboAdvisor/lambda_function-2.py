    ...
    if age is not None:
            ...
            if age <=0 or age >65:
                return build_validation_result(
                    False,
                    "age"
                    "You need to be between 1 to 64 years old to use this service",
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "Please increase your invest amount, cuz $5000 should be the minimun to use this service",
            )
...
def recommend_portfolio(intent_request):
    ...
    initialrecommendation = initial_recommendation(risk_level)
